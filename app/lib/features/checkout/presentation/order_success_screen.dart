...
class OrderSuccessScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PopScope(
      // Checkout replaces itself with this screen, so there is nothing behind
      // it. Intercept back and land on home rather than exiting the app.
      canPop: false,
              ...
              children: [
                ...
                order.maybeWhen(
                  data: (data) => Container(
                    ...
                    child: Text(
                      l10n.successOrderCode(data.code),
                ...
                PrimaryButton(
                  ...
                  // push, not go: backing out of tracking returns here rather
                  // than dead-ending, and home stays one tap away below.
                  onPressed: () => context.push(Routes.orderDetailPath(orderId)),
                ),
                Gap.md,
                TextButton(
